...
MainWindow::MainWindow(QWidget *p_parent)
    : FramelessMainWindow(!ConfigMgr::getInst().getSessionConfig().getSystemTitleBarEnabled(), p_parent),
...
void MainWindow::closeEvent(QCloseEvent *p_event)
{
    ...
    if (isExit || !m_trayIcon->isVisible()) {
        ...
        FramelessMainWindow::closeEvent(p_event);
...
void MainWindow::changeEvent(QEvent *p_event)
{
    ...
    FramelessMainWindow::changeEvent(p_event);
}
